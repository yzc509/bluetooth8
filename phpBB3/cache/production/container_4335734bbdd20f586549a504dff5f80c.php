...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000071a54c840000000023ad89b8(
...
class phpbbtemplatetwiglexer_0000000071a54c840000000023ad89b8 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c315d62c382b391872282 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c315d62c3831654834177 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c315d62c3814582203530 = array(
    ...
    {
        $this->initializer5c315d62c3831654834177 && ($this->initializer5c315d62c3831654834177->__invoke($valueHolder5c315d62c382b391872282, $this, 'set_environment', array('env' => $env), $this->initializer5c315d62c3831654834177) || 1) && $this->valueHolder5c315d62c382b391872282 = $valueHolder5c315d62c382b391872282;

        return $this->valueHolder5c315d62c382b391872282->set_environment($env);
    }
    ...
    {
        $this->initializer5c315d62c3831654834177 && ($this->initializer5c315d62c3831654834177->__invoke($valueHolder5c315d62c382b391872282, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5c315d62c3831654834177) || 1) && $this->valueHolder5c315d62c382b391872282 = $valueHolder5c315d62c382b391872282;

        return $this->valueHolder5c315d62c382b391872282->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5c315d62c3831654834177 && ($this->initializer5c315d62c3831654834177->__invoke($valueHolder5c315d62c382b391872282, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5c315d62c3831654834177) || 1) && $this->valueHolder5c315d62c382b391872282 = $valueHolder5c315d62c382b391872282;

        return $this->valueHolder5c315d62c382b391872282->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5c315d62c3831654834177 = $initializer;
    }
    ...
    {
        $this->initializer5c315d62c3831654834177 && ($this->initializer5c315d62c3831654834177->__invoke($valueHolder5c315d62c382b391872282, $this, '__get', array('name' => $name), $this->initializer5c315d62c3831654834177) || 1) && $this->valueHolder5c315d62c382b391872282 = $valueHolder5c315d62c382b391872282;

        if (isset(self::$publicProperties5c315d62c3814582203530[$name])) {
            return $this->valueHolder5c315d62c382b391872282->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c315d62c382b391872282;
    ...
    {
        $this->initializer5c315d62c3831654834177 && ($this->initializer5c315d62c3831654834177->__invoke($valueHolder5c315d62c382b391872282, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c315d62c3831654834177) || 1) && $this->valueHolder5c315d62c382b391872282 = $valueHolder5c315d62c382b391872282;
    ...
    {
        $this->initializer5c315d62c3831654834177 && ($this->initializer5c315d62c3831654834177->__invoke($valueHolder5c315d62c382b391872282, $this, '__isset', array('name' => $name), $this->initializer5c315d62c3831654834177) || 1) && $this->valueHolder5c315d62c382b391872282 = $valueHolder5c315d62c382b391872282;
    ...
    {
        $this->initializer5c315d62c3831654834177 && ($this->initializer5c315d62c3831654834177->__invoke($valueHolder5c315d62c382b391872282, $this, '__unset', array('name' => $name), $this->initializer5c315d62c3831654834177) || 1) && $this->valueHolder5c315d62c382b391872282 = $valueHolder5c315d62c382b391872282;
    ...
    {
        $this->initializer5c315d62c3831654834177 && ($this->initializer5c315d62c3831654834177->__invoke($valueHolder5c315d62c382b391872282, $this, '__clone', array(), $this->initializer5c315d62c3831654834177) || 1) && $this->valueHolder5c315d62c382b391872282 = $valueHolder5c315d62c382b391872282;

        $this->valueHolder5c315d62c382b391872282 = clone $this->valueHolder5c315d62c382b391872282;
    }

    public function __sleep()
    {
        $this->initializer5c315d62c3831654834177 && ($this->initializer5c315d62c3831654834177->__invoke($valueHolder5c315d62c382b391872282, $this, '__sleep', array(), $this->initializer5c315d62c3831654834177) || 1) && $this->valueHolder5c315d62c382b391872282 = $valueHolder5c315d62c382b391872282;

        return array('valueHolder5c315d62c382b391872282');
    }
    ...
    {
        return $this->initializer5c315d62c3831654834177;
    }
    ...
    {
        return $this->initializer5c315d62c3831654834177 && ($this->initializer5c315d62c3831654834177->__invoke($valueHolder5c315d62c382b391872282, $this, 'initializeProxy', array(), $this->initializer5c315d62c3831654834177) || 1) && $this->valueHolder5c315d62c382b391872282 = $valueHolder5c315d62c382b391872282;
    }
    ...
    {
        return null !== $this->valueHolder5c315d62c382b391872282;
    }
    ...
    {
        return $this->valueHolder5c315d62c382b391872282;
    }
