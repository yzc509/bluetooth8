...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000076c45fbb0000000068aa1c4a(
...
class phpbbtemplatetwiglexer_0000000076c45fbb0000000068aa1c4a extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c315d6cf0819474159018 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c315d6cf081e257284004 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c315d6cf0807707756134 = array(
    ...
    {
        $this->initializer5c315d6cf081e257284004 && ($this->initializer5c315d6cf081e257284004->__invoke($valueHolder5c315d6cf0819474159018, $this, 'set_environment', array('env' => $env), $this->initializer5c315d6cf081e257284004) || 1) && $this->valueHolder5c315d6cf0819474159018 = $valueHolder5c315d6cf0819474159018;

        return $this->valueHolder5c315d6cf0819474159018->set_environment($env);
    }
    ...
    {
        $this->initializer5c315d6cf081e257284004 && ($this->initializer5c315d6cf081e257284004->__invoke($valueHolder5c315d6cf0819474159018, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5c315d6cf081e257284004) || 1) && $this->valueHolder5c315d6cf0819474159018 = $valueHolder5c315d6cf0819474159018;

        return $this->valueHolder5c315d6cf0819474159018->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5c315d6cf081e257284004 && ($this->initializer5c315d6cf081e257284004->__invoke($valueHolder5c315d6cf0819474159018, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5c315d6cf081e257284004) || 1) && $this->valueHolder5c315d6cf0819474159018 = $valueHolder5c315d6cf0819474159018;

        return $this->valueHolder5c315d6cf0819474159018->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5c315d6cf081e257284004 = $initializer;
    }
    ...
    {
        $this->initializer5c315d6cf081e257284004 && ($this->initializer5c315d6cf081e257284004->__invoke($valueHolder5c315d6cf0819474159018, $this, '__get', array('name' => $name), $this->initializer5c315d6cf081e257284004) || 1) && $this->valueHolder5c315d6cf0819474159018 = $valueHolder5c315d6cf0819474159018;

        if (isset(self::$publicProperties5c315d6cf0807707756134[$name])) {
            return $this->valueHolder5c315d6cf0819474159018->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c315d6cf0819474159018;
    ...
    {
        $this->initializer5c315d6cf081e257284004 && ($this->initializer5c315d6cf081e257284004->__invoke($valueHolder5c315d6cf0819474159018, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c315d6cf081e257284004) || 1) && $this->valueHolder5c315d6cf0819474159018 = $valueHolder5c315d6cf0819474159018;
    ...
    {
        $this->initializer5c315d6cf081e257284004 && ($this->initializer5c315d6cf081e257284004->__invoke($valueHolder5c315d6cf0819474159018, $this, '__isset', array('name' => $name), $this->initializer5c315d6cf081e257284004) || 1) && $this->valueHolder5c315d6cf0819474159018 = $valueHolder5c315d6cf0819474159018;
    ...
    {
        $this->initializer5c315d6cf081e257284004 && ($this->initializer5c315d6cf081e257284004->__invoke($valueHolder5c315d6cf0819474159018, $this, '__unset', array('name' => $name), $this->initializer5c315d6cf081e257284004) || 1) && $this->valueHolder5c315d6cf0819474159018 = $valueHolder5c315d6cf0819474159018;
    ...
    {
        $this->initializer5c315d6cf081e257284004 && ($this->initializer5c315d6cf081e257284004->__invoke($valueHolder5c315d6cf0819474159018, $this, '__clone', array(), $this->initializer5c315d6cf081e257284004) || 1) && $this->valueHolder5c315d6cf0819474159018 = $valueHolder5c315d6cf0819474159018;

        $this->valueHolder5c315d6cf0819474159018 = clone $this->valueHolder5c315d6cf0819474159018;
    }

    public function __sleep()
    {
        $this->initializer5c315d6cf081e257284004 && ($this->initializer5c315d6cf081e257284004->__invoke($valueHolder5c315d6cf0819474159018, $this, '__sleep', array(), $this->initializer5c315d6cf081e257284004) || 1) && $this->valueHolder5c315d6cf0819474159018 = $valueHolder5c315d6cf0819474159018;

        return array('valueHolder5c315d6cf0819474159018');
    }
    ...
    {
        return $this->initializer5c315d6cf081e257284004;
    }
    ...
    {
        return $this->initializer5c315d6cf081e257284004 && ($this->initializer5c315d6cf081e257284004->__invoke($valueHolder5c315d6cf0819474159018, $this, 'initializeProxy', array(), $this->initializer5c315d6cf081e257284004) || 1) && $this->valueHolder5c315d6cf0819474159018 = $valueHolder5c315d6cf0819474159018;
    }
    ...
    {
        return null !== $this->valueHolder5c315d6cf0819474159018;
    }
    ...
    {
        return $this->valueHolder5c315d6cf0819474159018;
    }
