...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>需要了解更多的设定和权限管理信息，请访问 <a href="https://www.phpbb.com/support/docs/en/3.2/ug/quickstart/permissions/">快速指南的权限篇</a>.</p>
	',

	'ACL_NEVER'				=> '从不',
	'ACL_SET'				=> '权限设定',
	'ACL_SET_EXPLAIN'		=> '权限基于简单的 <strong>是</strong>/<strong>否</strong> 系统。设定用户组和用户选项为 <strong>从不</strong> 将覆盖其他设定的值。如果您不希望给这个用户或用户组设定值，请选择 <strong>否</strong>。如果值在其他地方设定，他们将在设定中使用，否则假定为 <strong>从不</strong>。所有选中的对象 (他们前面有勾选框) 将复制您设置的权限组。',
	'ACL_SETTING'			=> '设定',
	...
	'TRACE_USER_GLOBAL_YES_TOTAL_YES'		=> '用户的版面无关权限设置为 <strong>是</strong> 而原权限也已经设置为 <strong>是</strong>，所以最终还是一样的结果。%s追溯全局权限%s',
	'TRACE_USER_GLOBAL_YES_TOTAL_NEVER'		=> '用户的版面无关权限设置为 <strong>是</strong>，这将覆盖当前本地结果<strong>从不</strong>。%s追溯全局权限%s',
	'TRACE_USER_GLOBAL_NEVER_TOTAL_KEPT'	=> '用户的版面无关权限设置为 <strong>从不</strong>，这对于本地权限无影响。%s追溯全局权限%s',
