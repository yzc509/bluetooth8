...
$lang = array_merge($lang, array(
	'ACP_PRUNE_USERS_EXPLAIN'	=> '这里您可以将论坛中的会员删除（或者冻结）。 您可以有多种形式搜寻，然后删除。如：发帖数量和最后一次的时间等等... 这些方式可以自由组合， 如：您可以选用2002年1月1日之前发贴量少于10篇的会员来删除。 您也可以选择批量删除，只需要将会员名单放进删除栏目中即可。 此功能须小心使用！ 一旦用户被删除后将无法再恢复。',
	...
	'PRUNE_USERS_LIST_DEACTIVATE'	=> '使用选中的条件， 如下的用户帐号将被冻结。您可以在冻结列表里通过取消勾选来移除单个用户。',
