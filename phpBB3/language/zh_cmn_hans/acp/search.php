...
$lang = array_merge($lang, array(
	'ACP_SEARCH_INDEX_EXPLAIN'				=> '这里您可以管理内容索引。因为一般只使用一个后台引擎，您可以删除所有不用的索引。在改变搜索设置（例如最小/最大字符串长度）后， 建议重新生成索引使修改生效。',
  ...
  'MAX_NUM_SEARCH_KEYWORDS_EXPLAIN'      => '用于限制用户用于搜索的关键词的个数。填写 0 则不作限制。',
	...
	'SEARCH_INDEX_CREATE_REDIRECT'			=> array(
		1	=> '现有id %2$d 的贴子已被索引，正在索引 %1$d 帖子。<br />',
	),
	'SEARCH_INDEX_CREATE_REDIRECT_RATE'		=> array(
		1	=> '当前索引速率约为 %1$.1f 贴每秒。<br />索引中…',
	),
		'SEARCH_INDEX_DELETE_REDIRECT'			=> array(
		1	=> '所有达到id %2$d 的帖子已从搜索索引移除，其中 %1$d 帖子在此步骤中。<br />',
	),
	'SEARCH_INDEX_DELETE_REDIRECT_RATE'		=> array(
		1	=> '当前删除索引的速度大约是  %1$.1f 贴每秒。<br />正在删除中…',
	),
