...
$lang = array_merge($lang, array(
	...
	'CLI_DESCRIPTION_USER_ACTIVATE'				=> '激活 （或冻结） 用户账号。',
	...
	'CLI_DESCRIPTION_USER_ACTIVATE_INACTIVE'	=> '用户账号已经被冻结。',
	...
	'CLI_MIGRATION_NAME'					=> '变更名字，包括命名空间 （用正斜杠代替反斜杠以避免错误）。',
...
$lang = array_merge($lang, array(
	...
	'CLI_HELP_USER_ACTIVATE'	=> '激活一个用户，或者使用 <info>--冻结</info> 选项冻结一个用户。
可以使用  <info>--发送 email</info> 选项，来发送一个激活 email 给用户。',
