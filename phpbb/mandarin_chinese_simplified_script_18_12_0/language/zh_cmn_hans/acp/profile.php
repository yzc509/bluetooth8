...
$lang = array_merge($lang, array(
	...
	'DISPLAY_ON_PM'					=> '显示在查看站内短信屏幕',
	'DISPLAY_ON_PM_EXPLAIN'			=> '如果启用此选项，自动将显示在站内短信屏幕的迷你资料中。',
	...
	'STEP_3_EXPLAIN_CREATE'			=> '因为论坛安装了多种语言包，您必须填写下面的语言设置。若不设置，相关资料栏将工作于默认的语言下，您也可以以后再完成剩下的语言设置。',
