...
$lang = array_merge($lang, array(
	...
	// Support page
	'SUPPORT_TITLE'		=> '支持',
	'SUPPORT_BODY'		=> '我们将免费为此次发布的 phpBB3 稳定版本提供完全的技术支持。这包括:</p><ul><li>安装</li><li>设置</li><li>技术问题</li><li>与软件中潜在的 Bug 相关的问题</li><li>从先前发布的候选（RC）版本升级至最新稳定版本</li><li>从 phpBB 2.0.x 转换至 phpBB3</li><li>从其他的论坛转换至 phpBB3 (请访问 <a href="https://www.phpbb.com/community/viewforum.php?f=486">转换器论坛</a>)</li></ul><p>我们建议还在使用 phpBB3 Beta 版本的用户立即用最新的版本替换他们的系统.</p><h2>扩展/风格</h2><p>与扩展相关的问题，请发表在相应的 <a href="https://www.phpbb.com/community/viewforum.php?f=451">扩展论坛</a>.<br />与风格，模板和图集相关的问题，请发表在相应的 <a href="https://www.phpbb.com/community/viewforum.php?f=471">风格论坛</a>.<br /><br />如果您的问题与特定的包相关，请直接在相应包的主题后回帖.</p><h2>获得支持</h2><p><a href="https://www.phpbb.com/support/">支持部分</a><br /><a href="https://www.phpbb.com/support/docs/en/3.2/ug/quickstart/">快速开始指南</a><br /><br />为了确保您获得最新版本的相关信息，请关注我们的<a href="https://www.twitter.com/phpbb/">Twitter</a> 帐号和 <a href="https://www.facebook.com/phpbb/">Facebook</a> 帐号。<br /><br />',
...
$lang = array_merge($lang, array(
	...
	'DB_HOST_EXPLAIN'		=> 'DSN 代表数据源名称，它只与 ODBC 安装有关。对于 PostgreSQL，需要通过 UNIX domain socket 用 localhost 或通过 TCP 用 127.0.0.1 连接本地服务器。对于 SQLite，需要输入数据库文件的完整路径。',
	'DB_PORT'				=> '数据库服务器端口',
...
$lang = array_merge($lang, array(
	...
	'DEFAULT_INSTALL_POST'			=> '这是新安装好的 phpBB3 论坛中的一个样本帖子。您可以删除这个帖子、这个主题甚至这个版面， 因为一切看起来都运转正常！在整个安装过程中，你的第一个分区和第一个版面，都已经给与了适当的权限，预定义的用户组，管理员，蜘蛛，以及总版主，游客，注册用户，注册的 COPPA 用户。如果您选择删除这第一个分区和第一个版面，不要忘记在您新创建的分区和版面，给与用户组适当的权限。我们建议您重命名您的第一个分区和版面，并复制权限到您之后所创建的版面。祝您玩的快乐！',
...
$lang = array_merge($lang, array(
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>推荐的升级方法就是使用完整安装包。如果你所安装的 phpBB 系统中的核心文件曾经被你修改过，你也许想要用自动升级包来升级，以保留那些你所做的修改。你也可以采用在 INSTALL.html 里所列出的方法来升级。使用 phpBB 3 的完整安装包来升级的步骤是：</p>
		...
		<h1>如何使用自动升级包升级您的论坛</h1>
		<p>自动升级包只有当你的 phpBB 文件曾经被修改过的情况下，才推荐使用。您也可以采用 INSTALL.html 文档中列出的方式升级。自动升级 phpBB3 的步骤是：</p>
