...
if ($params->get('show_button', 1))
{
	...
	$button = '<input class="button dd-search-button ' . $suffix . ' finder' . $suffix . '" type="submit" value="' . JText::_('MOD_FINDER_SEARCH_BUTTON') . '">';
...
<form id="mod-finder-searchform" action="<?php echo JRoute::_($route); ?>" method="get" class="dd-search">
